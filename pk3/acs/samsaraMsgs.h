...
int ClassPickupMessages[CLASSCOUNT][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    },
    {
        ...
        },
        {
            ...
            "How much did you spend to get your insignia built into the case?",
            "Oh my god, this game rips off Doom so much.",
        },
        {
...
int PunchDrunkUniqueMessages[CLASSCOUNT][MSGCOUNT] =
{
    ...
    {
        "You got popcorn stabbing power!",
        "This is not what we meant by a butter knife!",
        "You are now the king of prison.",
        "Don't eat it.",
        "So that's what those years of karate were meant to teach me...",
        "Good for the stomach, too.",
        "It spawns infinite amount of food. omg jesus knife",
        "",
        "",
        "",
    },
