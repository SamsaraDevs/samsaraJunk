...
int ClassPickupMessages[CLASSCOUNT][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    },
    {
        ...
        },
        {
            ...
            "How can I hold all these kills?",
...
int ClassUniqueMessages[CLASSCOUNT][MSGCOUNT] =
{
    ...
    },
    {
        ...
        "It's like a little Christmas every second.",
        "What's next, chest-high walls?",
        "Hi there, appendix, I missed you too!",
        "So what do you grow back after 100% health?",
        "Because being at 5% health really hindered you. What with all the blood and pain.",
        "",
        "",
    },
};
